...
import ProfilePic from "./cherrypfp.png";
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] text-[#333333] flex flex-col items-center justify-center">
      ...
      <Image
        ...
        width={128}
        height={128}
        className="rounded-full border-4 border-[#EAEAEA] shadow-lg mb-6"
      />
      ...
      <Address address="0xC52E3E454a735d4A74F3dd6Ea281F7AebDFAad83" onlyEnsOrAddress={true} />
    </div>
  );
};

export default CherryBuilderPage;
